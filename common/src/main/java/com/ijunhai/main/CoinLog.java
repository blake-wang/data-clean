...
public class CoinLog implements Serializable {
    private static String GROUP = "CoinLog";
...
//        optionParams.put(RocketMQConfig.CONSUMER_GROUP,"testOrder");
        ...
        String appName = nameServer + ":CoinLog";
...
//
        ...
        dStream.transform(new Function<JavaRDD<MessageExt>, JavaRDD<MessageExt>>() {
            ...
            public void call(JavaRDD<MessageExt> messageExtJavaRDD) throws Exception {
                ...
                CoinProcess.process(CommonProcess.extraCoin(messageExtJavaRDD.rdd()), "json",kafkaSink,topic);
