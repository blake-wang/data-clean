...
public class Log2GP implements Serializable {
    private static String GROUP = "Log2GP";
...
//                System.out.println(messageExtJavaRDD.rdd().count());
                Log2GPProcess.tmpLogProcess(messageExtJavaRDD.rdd(), kafkaSinkBroadcast, GPSink, offsetRanges.get(), nameServer, topics, GROUP, redisSinkCluster);
            }
        });
