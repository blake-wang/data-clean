...
import com.ijunhai.common.offset.trail.kafkaOffset
...
/**
  ...
  */
object redisKafkaOffset extends kafkaOffset{
//  private final val redisConn=RedisClient.getInstatnce.getJedis
  override def saveOffset(offsets: Array[OffsetRange], nameServer: String, topic: String, groupId: String,redisSink: Broadcast[RedisSink]): Unit = {
  ...
  override def readOffset(nameServer: String, topic: String, groupId: String,redisSink: Broadcast[RedisSink]): util.HashMap[TopicPartition, Long] = {
